import { BankAccountStatus, BankAccountType, ReconciliationItemType } from '@/domain/value-objects';
import { z } from 'zod';
 ...
 */
export const updateCashThresholdSchema = z
  .object({
  ...
  .refine((data) => data.criticalThreshold > data.emergencyThreshold, {
