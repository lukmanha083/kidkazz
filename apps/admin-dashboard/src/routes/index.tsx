    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="w-full max-w-md px-4">
        ...
        <Card className="border shadow-lg">
          ...
          <CardContent>
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-2">
              <p className="text-xs font-medium text-foreground">Try it out:</p>
              <div className="text-xs text-muted-foreground space-y-1">
                <p>Email: <span className="font-mono">admin@kidkazz.com</span></p>
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          Dual-Market E-Commerce Platform (B2C + B2B)
          <br />
          <span className="text-[10px]">Built with shadcn/ui & TanStack Router</span>
        </p>
      </div>
    </div>
  );
