...
import { Plus, X, FolderTree, Loader2 } from "lucide-react";
							...
							{(field) => (
								<div className="space-y-2">
									...
									<p className="text-xs text-muted-foreground">
										Only top-level categories can be selected as parents. We
										support 2 levels: category and subcategory.
									</p>
								</div>
							)}
						</form.Field>
						...
						<AlertDialogDescription>
							{categoryToDelete && (
								<>
									...
									<strong>"{categoryToDelete.name}"</strong>. This action cannot
									be undone. Products in this category will become
									uncategorized.
								</>
							)}
						</AlertDialogDescription>
