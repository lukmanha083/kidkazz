...
function ProductVariantPage() {
  ...
  const handleProductSelect = async (productSKU: string) => {
    ...
    if (product) {
      ...
      form.setFieldValue(
        'variantSKU',
        generateVariantSKU(product.sku, form.getFieldValue('variantName'))
      );
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: handlers are stable and intentionally excluded to prevent unnecessary re-renders
      ...
      <Drawer open={formDrawerOpen} onOpenChange={setFormDrawerOpen}>
        <DrawerContent side="left">
          <DrawerHeader className="relative">
            ...
            <DrawerTitle>{formMode === 'add' ? 'Add New Variant' : 'Edit Variant'}</DrawerTitle>
            <DrawerDescription>
              {formMode === 'add' ? 'Create a new product variant' : 'Update variant information'}
            </DrawerDescription>
          </DrawerHeader>
          ...
          >
              ...
              <div className="p-3 bg-muted/30 rounded-md space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-green-600 dark:text-green-500">
                    {getRemainingStock(form.getFieldValue('productSKU'), selectedVariant?.id)} units
                  </span>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="border rounded-md bg-blue-50/50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
                  <div className="p-3 space-y-2">
                    {parentProductLocations.slice(0, 3).map((loc) => (
                      <div
                        key={loc.warehouseId}
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground mt-2 p-2 bg-muted/50 rounded border">
                  Stock is managed by the Inventory Service and not editable here. Use the Inventory
                  page to adjust stock levels.
                </p>
              </div>
            </div>
            ...
            <div className="p-3 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded">
              <p className="text-sm text-blue-900 dark:text-blue-100">
                <strong>Note:</strong> Warehouse allocation and stock management for variants is
                handled by the Inventory Service. Use the Inventory page to manage stock levels
                across warehouses.
              </p>
            </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {variantToDelete && (
                <>
                  You are about to delete variant <strong>"{variantToDelete.variantName}"</strong>{' '}
                  of <strong>{variantToDelete.productName}</strong>. This action cannot be undone.
                  This will permanently delete the variant and remove all associated data.
                </>
              )}
            </AlertDialogDescription>
          </AlertDialogHeader>
