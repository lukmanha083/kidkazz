  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        side === 'bottom' && 'inset-x-0 bottom-0 mt-24 rounded-t-[10px] max-h-[90vh]',
        side === 'left' && 'inset-y-0 left-0 h-full w-full tablet:w-[540px] rounded-r-[10px]',
        side === 'right' && 'inset-y-0 right-0 h-full w-full tablet:w-[540px] rounded-l-[10px]',
        className
      )}
...
const DrawerHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('grid gap-1.5 p-4 text-center tablet:text-left', className)} {...props} />
);
